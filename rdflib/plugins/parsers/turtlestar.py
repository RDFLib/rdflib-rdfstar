...
def RDFstarParsings(rdfstarstring):
    global quotationannolist, vblist, quotation_dict, quotationreif, prefix_list, constructors, assertedtriplelist, quoted_or_not, both_quoted_and_asserted, to_remove, annotation_s_p_o, output, annotation_dict, prefix_dictionary
    quotationannolist = []
    vblist = []
    quotationreif = []
    prefix_list = []
    ...
    for x in range(0, len(prefix_list)):
        print("prefix", prefix_list[x], prefix_dictionary)
