...
triplesorgraph: labelorsubject (wrappedgraph | predicate_object_list ".")
...
f = open("trig-star/trig-star-syntax-nested-01.trig", "rb")
rdbytes = f.read()
f.close()
...
tree = trig_lark.parse(rdbytes_processing)
print(tree)
print("\n")
print("\n")
print("\n")
...
constructors = ":G{\n" + constructors
constructors = constructors+"}" # insert 0
